    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Subject Option Edit</h3>
            </div>
            <?php echo form_open('mark/edit/' . $subjectoption['id']); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <label for="studentid" class="control-label">Student Subject Option</label>
