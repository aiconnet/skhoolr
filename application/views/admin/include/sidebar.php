     ...
     <!-- <li id="adminlte" class="treeview">
      ...
      <li id="tables" class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li id="student-list"><a href="<?= base_url('/student'); ?>"><i class="fa fa-circle-o"></i> Student List</a></li>
          <li id="add-student"><a href="<?= base_url('student/add'); ?>"><i class="fa fa-circle-o"></i> Add Student</a></li>
      ...
      <li id="tables" class="treeview">
        ...
        <ul class="treeview-menu">
          <!-- <li id="student-list"><a href="<?= base_url('adminlte/teacher'); ?>"><i class="fa fa-circle-o"></i> Student List</a></li>
          <li id="add-student"><a href="<?= base_url('adminlte/add'); ?>"><i class="fa fa-circle-o"></i> Add Student</a></li> -->

          <li id="student-list"><a href="<?= base_url('/teacher'); ?>"><i class="fa fa-circle-o"></i> Teacher List</a></li>
          <li id="add-student"><a href="<?= base_url('adminlte/add'); ?>"><i class="fa fa-circle-o"></i> Add Teacher</a></li>
      ...
      <li id="tables" class="treeview">
        <a href="#">
          <i class="fa fa-table"></i> <span>Subjects</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          ...
          <li id="subject-list"><a href="<?= base_url('/subject'); ?>"><i class="fa fa-circle-o"></i> Subject List</a></li>
          <li id="add-subject"><a href="<?= base_url('subject/add'); ?>"><i class="fa fa-circle-o"></i> Add Subject</a></li>
          <li id="add-student"><a href="<?= base_url('/subjectoptions'); ?>"><i class="fa fa-circle-o"></i>Options Management</a></li>
      ...
      <li id="tables" class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li id="mark-list-bot"><a href="<?= base_url('/mark'); ?>"><i class="fa fa-circle-o"></i> Mark List - (BOT)</a></li>
          <li id="mark-list-eot"><a href="<?= base_url('/markeot'); ?>"><i class="fa fa-circle-o"></i> Mark List - (EOT)</a></li>
          <li id="mark-list-eot"><a href="<?= base_url('/markeot2'); ?>"><i class="fa fa-circle-o"></i> Mark List -(BOT) & (EOT)</a></li>
         <!-- <li id="add-mark"><a href="<?= base_url('adminlte/add'); ?>"><i class="fa fa-circle-o"></i> Add Marks</a></li>-->
