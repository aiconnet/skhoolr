<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <?php echo form_open('markeot/edit/' . $mark['id']); ?>
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <label for="mark1" class="control-label">Mark2</label>
                        <div class="form-group">
                            <input type="text" name="mark2" value="<?php echo ($this->input->post('mark2') ? $this->input->post('mark2') : $mark['mark2']); ?>" class="form-control" id="mark1" />
                            <span class="text-danger"><?php echo form_error('mark2'); ?></span>
                        </div>
                    </div>
                    <div class="col-md-6">
