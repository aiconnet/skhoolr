...
<section class="content-header">
    <h1>
        Student Beginning Of Term Marks
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Ordinary Level - Beginning Of Term Marks</h3>
                </div>
                ...
                echo form_open_multipart('mark/import_data', $attributes); ?>
                ...
                <div class="text-right box-tools">
                    <a href="<?php echo site_url('mark/add'); ?>" class="btn btn-success btn-sm">Add Marks</a>
                    <a href="<?php echo site_url('mark/add_stream'); ?>" class="btn btn-success btn-sm">Register Stream Marks</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
