    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Generate Student's End of Term Report</h3>
            </div>
            
            
			<?php // echo form_open('student/generate_report/'.$student['id']); ?>
            
            <?php echo form_open(base_url()."student/generate_pdf_eot");?>
			...
			<div class="box-footer"> 
            	...
            	<button type="submit" name="submit" class="btn btn-success"><i class="fa fa-check"></i> Generate End Of Term  Report</button>
	        </div>				
			<?php echo form_close(); ?>
		</div>
    </div>
